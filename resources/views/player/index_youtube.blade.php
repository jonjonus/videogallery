        ...
        <div class="col-sm-12 col-md-8 col-lg-9">
            <div class="embed-responsive embed-responsive-16by9" style="width:95.5%; margin-top: 10px;">
                ...
                <div id="player-wrapper">
                    <div id="player_youtube"  class="embed-responsive-item" style="display: none"></div>
                    <iframe id="player_noapi" class="embed-responsive-item" style="display: none"></iframe>
                </div>
            </div>
            <div class="vidTitle">
...
@section('scripts')
    <script src="/js/player_youtube.js"></script>
@endsection